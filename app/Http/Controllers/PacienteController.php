...
class PacienteController extends Controller
{
    public function store(Request $request)
    {
        ...
        try {
            ...
            Log::info('Incidencia@store - Paciente creado en MySQL local', [
                'id_paciente'      => $paciente->id_paciente,
                'numero_documento' => $datos['numero_documento'],
            ]);
        } catch (\Throwable $e) {
            Log::error('Incidencia@store - Falló el registro', [
            ...
            return back()->withErrors(['general' => 'Ocurrió un error al registrar la incidencia. No se guardó ningún dato.'])->withInput();
        }
